...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `cel-flash-stomp` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/cel-flash-stomp.mp4) |
...
- 参数卡原文 [cel-flash-stomp.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/typography/cel-flash-stomp.md)
- 上游实现 [typography/cel-flash-stomp](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/typography/cel-flash-stomp)
