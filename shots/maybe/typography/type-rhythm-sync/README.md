...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `font-weight-pump` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/font-weight-pump.mp4) |
| `karaoke-fill-sync` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/karaoke-fill-sync.mp4) |
...
- 参数卡原文 [type-rhythm-sync.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/typography/type-rhythm-sync.md)
- 上游实现 [typography/type-rhythm-sync](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/typography/type-rhythm-sync)
