...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `cloner-depth-echo` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/cloner-depth-echo.mp4) |
...
- 参数卡原文 [cloner-depth-echo.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/ui-entrance/cloner-depth-echo.md)
- 上游实现 [ui-entrance/cloner-depth-echo](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/ui-entrance/cloner-depth-echo)
