...
穿越式转场两式——共享元素归位、字腔穿越，镜头钻进画面里的真实元素完成换景
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `letterform-zoom` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/letterform-zoom.mp4) |
| `shared-element-morph` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/shared-element-morph.mp4) |
...
- 参数卡原文 [transition-travel.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/transition/transition-travel.md)
- 上游实现 [transition/transition-travel](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/transition/transition-travel)
