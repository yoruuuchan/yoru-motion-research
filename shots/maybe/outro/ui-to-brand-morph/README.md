...
UI 变品牌两式——icon-flip-bloom 图标 Y 轴翻扁成竖线绽放成花形 mark + wordmark 逐字落定，与 input-morph-assemble 输入框收缩成胶囊、三粒图元落下集结成 logo 单瓣
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `input-morph-assemble` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/input-morph-assemble.mp4) |
...
- 参数卡原文 [ui-to-brand-morph.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/outro/ui-to-brand-morph.md)
- 上游实现 [outro/ui-to-brand-morph](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/outro/ui-to-brand-morph)
