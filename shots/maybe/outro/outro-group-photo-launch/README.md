...
全片元素从四面八方飞来围住字标合影，crane 落机位+舞台光+金尘做成发布会收场
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `outro-group-photo-launch` | maybe |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/outro-group-photo-launch.mp4) |
...
- 参数卡原文 [outro-group-photo-launch.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/outro/outro-group-photo-launch.md)
- 上游实现 [outro/outro-group-photo-launch](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/outro/outro-group-photo-launch)
