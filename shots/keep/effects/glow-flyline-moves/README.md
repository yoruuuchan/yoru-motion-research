...
暗场光斑与飞线三式——glow-orb-ambient 光斑底噪、flyline-arc 飞线连接、orb-flyline-relay 同帧共振组合
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `flyline-arc` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/flyline-arc.mp4) |
| `orb-flyline-relay` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/orb-flyline-relay.mp4) |
...
- 参数卡原文 [glow-flyline-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/effects/glow-flyline-moves.md)
- 上游实现 [effects/glow-flyline-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/effects/glow-flyline-moves)
