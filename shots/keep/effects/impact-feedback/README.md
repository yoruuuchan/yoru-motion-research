...
命中反馈两式——hit-counter 连招计数（顿帧+伤害数字+combo 跳字）、anime-impact 动漫打击帧（负片+集中线+色散）
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `anime-impact` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/anime-impact.mp4) |
| `hit-counter` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/hit-counter.mp4) |
...
- 参数卡原文 [impact-feedback.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/effects/impact-feedback.md)
- 上游实现 [effects/impact-feedback](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/effects/impact-feedback)
