...
打字机两式——terminal-typewriter 终端命令敲完即引爆场景切换、error-retype 误删重打的"改口"三幕剧
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `error-retype` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/error-retype.mp4) |
| `terminal-typewriter` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/terminal-typewriter.mp4) |
...
- 参数卡原文 [typewriter-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/typography/typewriter-moves.md)
- 上游实现 [typography/typewriter-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/typography/typewriter-moves)
