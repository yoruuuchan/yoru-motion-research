...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `drift-assembly` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/drift-assembly.mp4) |
| `text-on-path` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/text-on-path.mp4) |
