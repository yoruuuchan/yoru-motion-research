...
底边上推换章——新场景连底色整屏从底边向上推入，把旧场景物理顶出画外，连推数章各配一种饱和底色，内容钉死在各自色底坐标系里随底色走
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `bottom-push-stack-wipe` | keep | 4 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/bottom-push-stack-wipe.mp4) |
...
- 参数卡原文 [bottom-push-stack-wipe.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/transition/bottom-push-stack-wipe.md)
- 上游实现 [transition/bottom-push-stack-wipe](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/transition/bottom-push-stack-wipe)
