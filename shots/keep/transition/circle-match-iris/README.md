...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `circle-match-iris` | keep | 3 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/circle-match-iris.mp4) |
...
- 参数卡原文 [circle-match-iris.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/transition/circle-match-iris.md)
- 上游实现 [transition/circle-match-iris](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/transition/circle-match-iris)
