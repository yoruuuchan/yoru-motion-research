...
镜头交棒六式——推进流白、穿暗场直航、虚焦接力、黑场字卡、whip-pan 甩镜、mask-wipe 穿窗（含纵深款），按能量落差选型
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `shot-transitions-5` | keep | 5 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/shot-transitions-5.mp4) |
| `flash-cut` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/flash-cut.mp4) |
| `shot-transitions-4` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/shot-transitions-4.mp4) |
| | | | 备注：色彩风格想改成冷色系 |
...
- 参数卡原文 [shot-transitions.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/transition/shot-transitions.md)
- 上游实现 [transition/shot-transitions](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/transition/shot-transitions)
