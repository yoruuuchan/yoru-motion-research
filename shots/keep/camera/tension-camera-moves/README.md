# tension-camera-moves

**运镜与空间**

情绪运镜四式——bullet-time 冻结环绕、dutch-roll 斜角滚正、slow-push 慢推压迫、pull-back 拉远孤立，相机替观众"感受"而非"看"
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `bullet-time-freeze-orbit` | keep | 4 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/bullet-time-freeze-orbit.mp4) |
| `dutch-roll-to-level` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/dutch-roll-to-level.mp4) |
| `pull-back-isolation` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/pull-back-isolation.mp4) |
...
- 参数卡原文 [tension-camera-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/camera/tension-camera-moves.md)
- 上游实现 [camera/tension-camera-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/camera/tension-camera-moves)
