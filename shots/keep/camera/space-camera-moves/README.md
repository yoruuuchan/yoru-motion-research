...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `drone-dive-landing` | keep | 4 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/drone-dive-landing.mp4) |
| `exploded-view` | keep | 4 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/exploded-view.mp4) |
...
- 参数卡原文 [space-camera-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/camera/space-camera-moves.md)
- 上游实现 [camera/space-camera-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/camera/space-camera-moves)
