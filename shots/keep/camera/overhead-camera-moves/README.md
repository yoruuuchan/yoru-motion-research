...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `overhead-tabletop-drop` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/overhead-tabletop-drop.mp4) |
| `tilt-reveal` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/tilt-reveal.mp4) |
...
- 参数卡原文 [overhead-camera-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/camera/overhead-camera-moves.md)
- 上游实现 [camera/overhead-camera-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/camera/overhead-camera-moves)
