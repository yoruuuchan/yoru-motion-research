...
协作光标当演员的两式——dialogue-duet 双光标暗场对话双人舞（靠近/绕位/灯光交接/放大成转场），与 cast-ensemble 五光标群演氛围层（错峰飞入+正弦漂移+打字 cameo+聚拢围观）
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `cast-ensemble` | keep | 3 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/cast-ensemble.mp4) |
| `dialogue-duet` | keep | 3 | [看片](https://vincentwei1021.github.io/video-shotcraft/media/dialogue-duet.mp4) |
...
- 参数卡原文 [collab-cursor-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/interaction/collab-cursor-moves.md)
- 上游实现 [interaction/collab-cursor-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/interaction/collab-cursor-moves)
