...
分格节奏三式——grid-flash-mosaic 九宫格闪切填墙吞屏、flip-grid-reflow 网格集体重排、comic-panel-split 漫画斜格三机位并列
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `comic-panel-split` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/comic-panel-split.mp4) |
| `grid-flash-mosaic` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/grid-flash-mosaic.mp4) |
...
- 参数卡原文 [panel-grid-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/rhythm/panel-grid-moves.md)
- 上游实现 [rhythm/panel-grid-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/rhythm/panel-grid-moves)
