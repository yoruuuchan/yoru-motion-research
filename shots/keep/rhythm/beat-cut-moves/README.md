...
硬切当节拍乐器的两式——递进硬切串（间隔减半加速逼近）与连闪定格（三次白闪各切一个裁切）
...
| 变体 | 判断 | 分数 | 预览 |
|---|---|---:|---|
| `beat-cut-accelerando` | keep |  | [看片](https://vincentwei1021.github.io/video-shotcraft/media/beat-cut-accelerando.mp4) |
...
- 参数卡原文 [beat-cut-moves.md](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/references/shots/rhythm/beat-cut-moves.md)
- 上游实现 [rhythm/beat-cut-moves](https://github.com/Vincentwei1021/video-shotcraft/blob/0d6f0b57f0d4d6700761644c07f7ef03c3e50234/demos/rhythm/beat-cut-moves)
